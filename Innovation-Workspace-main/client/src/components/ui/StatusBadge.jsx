...
const STATUS_STYLES = {
  ...
  tl_approved: "bg-teal-100 text-teal-800 border-teal-200",
  mentor_approved: "bg-teal-100 text-teal-800 border-teal-200",
  approved: "bg-emerald-100 text-emerald-800 border-emerald-200",
  completed: "bg-emerald-100 text-emerald-800 border-emerald-200",
  final_approved: "bg-emerald-100 text-emerald-800 border-emerald-200",

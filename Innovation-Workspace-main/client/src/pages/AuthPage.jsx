  ...
  return (
    <section className="app-page flex items-center justify-center px-4">
      <div className="glass-panel w-full max-w-2xl overflow-hidden rounded-[32px]">
        <div className="bg-slate-100 px-8 py-10 text-slate-900">
          <Logo />
        ...
        <div className="space-y-5 px-8 py-8">
          ...
          {mode === "register" ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Role selection removed: users are assigned default roles by the server */}
            ...
            <div className="rounded-[28px] border border-white/60 bg-white p-5 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur-md">
